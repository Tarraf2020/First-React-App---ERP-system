...
export default function Team_up(props) {

    const classes = useStyles();
    const [Team_, setTeam] = useState([]);
    ...
    const addData = async (e) => {
        ...
        try {
            ...
            await axios
                ...
                .then(res => {
                    ...
                    if (res.data === 1) {
                        ...
                        alert('Make Sure You Are Not Using Duplicate Team');
                        props.setTriger(false);
                        props.setBlr(false);
                    }
                });
            ...
            alert(
                "Make Sure You Are Not Using Duplicate Team " 
            );
            props.setTriger(false);
            props.setBlr(false);
        }
